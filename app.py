...
def create_app():
    ...
    def create_book():
        ...
        if form.validate_on_submit():
            book = Book(
                ...
                catalogue_id=form.catalogue_id.data if form.catalogue_id.data != 0 else None,
    ...
    def edit_book(id):
        ...
        if form.validate_on_submit():
            ...
            book.catalogue_id = form.catalogue_id.data if form.catalogue_id.data != 0 else None
